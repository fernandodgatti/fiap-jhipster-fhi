...
describe('Component Tests', () => {
  describe('Supermercado Management Component', () => {
    let comp: SupermercadoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SupermercadoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.supermercados?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
